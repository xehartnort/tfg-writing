...
El número medio de clústeres (\autoref{fig:pulsar_clusteres}) decrece de $\alpha=0.15$ a $\alpha=0.6$ una unidad, a continuación crece 1.25 clústeres de $\alpha=0.6$ a $\alpha=0.9$. Además en la (\autoref{fig:pulsar_fijas}) el número de vidas inmóviles crece casi 2 unidades respecto de $\alpha$.
