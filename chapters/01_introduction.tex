...
%En la construcción de von Neumman el vecindario está constituido por las células adyacentes verticales y horizontales, lo que se conoce como vecindario de Neumman, si además se consideran que las células adyacentes diagonales forman parte del vecindario, entonces pasaría a nombrarse vecindario de Moore.

% hay que decir lo que es una iteración
