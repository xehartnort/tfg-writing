...
El contenido de esta sección está extraído de los siguientes textos en orden de empleo: \cite{elLibro}, \cite{grandesNumeros} y \cite{loeve}. 
...
\item $Q=\{0,1\}$,
\item $f:\{0,1\}^{9} \rightarrow \{0,1\} $ viene dada por:
