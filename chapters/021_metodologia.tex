...
\item Cálculo de los promedios y sus intervalos de confianza para cada variable en cada iteración. %Adicionalmente se calcula el \textit{p-value} de un test de hipótesis que nos permita afirmar que la distribución de los valores medios es probablemente normal.
