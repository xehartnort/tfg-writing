...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{\linewidth} 
        \centering
        \includegraphics[height=.20\linewidth]{./images/glider_evo.png}
        \caption{}
	...
	\begin{subfigure}[b]{\linewidth} 
        \centering
        \includegraphics[height=0.18\linewidth]{./images/lightweightspaceship_evo.png}
        \caption{}
        \label{fig:lightweightspaceship_evo}
    \end{subfigure}
	\caption{De derecha a izquierda, 4 iteraciones de dos \textit{naves espaciales} del juego de vida de Conway.}
